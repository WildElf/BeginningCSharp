...
namespace ProgrammingAssignment4
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            // Creating teddy object centered in window
            Vector2 bearStartLocation = new Vector2((float)WINDOW_WIDTH / 2 - teddySprite.Width / 2, 
                (float)WINDOW_HEIGHT / 2 - teddySprite.Height / 2);
            teddy = new Teddy(teddySprite, bearStartLocation);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            // Make teddy draw itself, make all pickups in the list draw
