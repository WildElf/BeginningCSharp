...
namespace GameProject
{
    ...
    public class Projectile
    {
        ...
        {
            // move projectile
            //drawRectangle.X += (int)(GameConstants.FRENCH_FRIES_PROJECTILE_SPEED * gameTime.ElapsedGameTime.Milliseconds);
            if (type == ProjectileType.FrenchFries)
            {
                drawRectangle.Y += (int)(-1 * GameConstants.FRENCH_FRIES_PROJECTILE_SPEED * gameTime.ElapsedGameTime.Milliseconds);
            }

            if (type == ProjectileType.TeddyBear)
            {
                drawRectangle.Y += (int)(GameConstants.TEDDY_BEAR_PROJECTILE_SPEED * gameTime.ElapsedGameTime.Milliseconds);
            }
