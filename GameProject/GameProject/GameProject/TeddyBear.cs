...
namespace GameProject
{
    ...
    public class TeddyBear
    {
        ...
        public void Update(GameTime gameTime, bool burgerDead)
        {
            ...
            elapsedShotTime += milliseconds;

            if (elapsedShotTime > firingDelay && !burgerDead)
            {
                elapsedShotTime = 0;
                firingDelay = GetRandomFiringDelay();
                ...
                Projectile projectile = new Projectile(ProjectileType.TeddyBear,
                    ...
                    drawRectangle.X,drawRectangle.Y+GameConstants.TEDDY_BEAR_PROJECTILE_OFFSET,
